"""Tests for vergil_tooling.bin.vrg_check_pr_merge."""
...
from vergil_tooling.bin.vrg_check_pr_merge import extract_pr_ref, main

_MOD = "vergil_tooling.bin.vrg_check_pr_merge"
